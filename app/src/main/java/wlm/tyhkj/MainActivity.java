...
//        mDialog.setParameter(SpeechConstant.LANGUAGE, "zh_cn");
    ...
    @OnClick({R.id.video, R.id.bigLoad,R.id.realm,R.id.db,R.id.cut_view, R.id.pie_view, R.id.smartTable, R.id.diy, R.id.diy_photo, R.id.recyclerView, R.id.voice, R.id.caijian, R.id.nv, R.id.map, R.id.handler, R.id.UCBrowser, R.id.QQBrowser, R.id.webview, R.id.photo, R.id.upload, R.id.okhttp, R.id.Notification, R.id.viewpager})
...
//        intent.setClassName("com.uc.browser", "com.uc.browser.ActivityUpdate");
            ...
            case R.id.bigLoad:
                ...
                break;
            case R.id.video:
                startActivity( new Intent(this, JiaoZiPlayerActivity.class));
                break;
        }
    }
